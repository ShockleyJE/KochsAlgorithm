 ...
 * @Since Nov 29, 2014
 * 
 * Inherits from JPanel & overrides paintComponent 
 *  to draw lines for Koch fractal snowflakes
 * 
 *
 */
...
public class FractalPanel extends JPanel {
	...
	public void paintComponent( Graphics g ) {
		...
		for(Line line :lines){
			drawKochLine( g2,this.level, (KochLine)line);
		}
	} // end paintComponent() method

	/**
	 * method to draw koch lines
	 * 
	 * @param g2
	 * @param level
	 * @param line
